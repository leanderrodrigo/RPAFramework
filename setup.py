...
setup(
    ...
    install_requires=["mysql" , "psycopg2" , "pyodbc" , "openpyxl" , "requests" , "jsonpickle" , "datetime" , "tika" , "pillow" , "pywinauto" , "selenium" , "chromedriver_autoinstaller" , "geckodriver_autoinstaller"],
    license='MIT',
    keywords=['rpa'],
    classifiers=[
